...
If you want to participate in most public/FOSS projects using git, you'll want to get comfortable with using topic branches.
This is a separate branch for a particular topic or effort, even if you're making trivial changes such as spelling corrections. There are various advantages such as:

- a separate branch is easily updated so you don't get behind what's public or have to fight hard to stay up to date
- the separation makes it easier to modify/compress your commits to ease the review burden for (upstream) maintainers
- separation allows you to have multiple topics under development without so much chance of confusion

In a typical scenario[^remotes], I might have forked a repository on github and cloned my fork locally, added the upstream repo:
...
If your branchwork takes a while and there are upstream commits, then you might want to consider rebasing to keep it up to date:
...
- reword commit messages (pick-&gt;reword)
...
[^remotes]: See also my writing about [more sophisticated git remote usage](../vcs-remotes/) for private/public publishing.
