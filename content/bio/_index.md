...
- Pattern-maker: providing PoC solutions and usable, easily-extensible examples for SWEs
...
- Technical direction to improve SWE projects/teams and their process
...
- Clouds: AWS, and prior experience with: OCI, OpenStack, GCP
- Infrastructure as Code: Terraform/tofu, Terragrunt, Ansible, and prior experience with Chef, puppet, bcfg2, and others.
- Containers/Virtualization: docker, kubernetes, helm, QEMU/KVM, libvirt, proxmox
